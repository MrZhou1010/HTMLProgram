/**
 * Created by mobiletek on 2017/11/6.
 */

(function (w) {
    var commonApi = w.commonApi || {};
    commonApi.ajax = {
        getAjax: function (url, data, ok, error) {
            $.ajax({
                url: url,
                data: data,
                type: 'get',
        ...
        postAjax: function (url, data, ok, error) {
            $.ajax({
                url: url,
                type: 'post',
                data: data,
    ...
    commonApi.url = {
        ...
        getParameter:function (url,name) {
            var parameter = this.getAllParameter(url);
            return parameter[name];
        }
    };
    w.commonApi = commonApi;
    ...
    String.prototype.cutStr = function (len) {
        ...
        if (this.strlen() > len) {
            for (var k = len / 2; k < this.length; k++) {
                if (this.substr(0, k).strlen() >= len) {
                    newStr = this.substr(0, k) + "...";
                    break;
                }
            }
        }
